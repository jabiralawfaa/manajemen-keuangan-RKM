# Dokumentasi Endpoint DELETE untuk Sistem RKM Admin

## 1. Pendahuluan

Dokumen ini menjelaskan endpoint DELETE yang telah diimplementasikan dalam sistem RKM Admin berdasarkan kebutuhan fungsional dalam SRS (Software Requirements Specification).
