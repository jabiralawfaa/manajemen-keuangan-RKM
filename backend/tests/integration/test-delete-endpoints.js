// tests/test-delete-endpoints.js
...
async function testDeleteEndpoints() {
  console.log('🗑️  Memulai pengujian endpoint DELETE...');
...
async function testDeleteMembersEndpoint(tokens) {
  ...
  if (newMemberId) {
    // Test DELETE /api/members/:id (oleh ketua - seharusnya berhasil)
    console.log('\n   1. Menguji DELETE /api/members/:id (oleh ketua)');
    try {
      const response = await axios.delete(`${BASE_URL}/api/members/${newMemberId}`, { 
        headers: { 
          'Authorization': `Bearer ${tokens.admin}`,
          'Content-Type': 'application/json'
        } 
      });
      console.log('   ✅ DELETE /api/members/:id (oleh ketua): Berhasil - Status:', response.status);
    ...
    // Test DELETE /api/members/:id (oleh sekretaris - seharusnya gagal)
    console.log('\n   2. Menguji DELETE /api/members/:id (oleh sekretaris - seharusnya gagal)');
    try {
      const response2 = await axios.delete(`${BASE_URL}/api/members/${newMemberId2}`, { 
        headers: { 
          'Authorization': `Bearer ${tokens.sekretaris}`,
          'Content-Type': 'application/json'
        } 
      });
      console.log('   ❌ DELETE /api/members/:id (oleh sekretaris): Seharusnya gagal tapi berhasil - Status:', response2.status);
    } catch (error) {
      if (error.response && error.response.status === 403) {
        console.log('   ✅ DELETE /api/members/:id (oleh sekretaris): Ditolak dengan benar - Status:', error.response.status);
        console.log('      Pesan:', error.response.data.message);
      } else {
        console.log('   ❌ DELETE /api/members/:id (oleh sekretaris): Error tak terduga -', error.response?.data?.message || error.message);
      }
    }

    // Test DELETE /api/members/:id (oleh bendahara - seharusnya gagal)
    console.log('\n   3. Menguji DELETE /api/members/:id (oleh bendahara - seharusnya gagal)');
    try {
      const newMember3 = {
      ...
      const newMemberId3 = createResponse3.data.member.id;
      console.log('   ➕ Anggota baru dibuat untuk pengujian delete bendahara:', newMemberId3);

      const response3 = await axios.delete(`${BASE_URL}/api/members/${newMemberId3}`, { 
        headers: { 
          'Authorization': `Bearer ${tokens.bendahara}`,
          'Content-Type': 'application/json'
        } 
      });
      console.log('   ❌ DELETE /api/members/:id (oleh bendahara): Seharusnya gagal tapi berhasil - Status:', response3.status);
    } catch (error) {
      if (error.response && error.response.status === 403) {
        console.log('   ✅ DELETE /api/members/:id (oleh bendahara): Ditolak dengan benar - Status:', error.response.status);
        console.log('      Pesan:', error.response.data.message);
      } else {
        console.log('   ❌ DELETE /api/members/:id (oleh bendahara): Error tak terduga -', error.response?.data?.message || error.message);
      }
    }
  }
}
...
async function testDeletePaymentsEndpoint(tokens) {
  ...
  if (newPaymentId) {
    // Test DELETE /api/payments/:id (oleh ketua - seharusnya berhasil)
    console.log('\n   1. Menguji DELETE /api/payments/:id (oleh ketua)');
    try {
      const response = await axios.delete(`${BASE_URL}/api/payments/${newPaymentId}`, { 
        headers: { 
          'Authorization': `Bearer ${tokens.admin}`,
          'Content-Type': 'application/json'
        } 
      });
      console.log('   ✅ DELETE /api/payments/:id (oleh ketua): Berhasil - Status:', response.status);
      console.log('      Pesan:', response.data.message);
    } catch (error) {
      console.log('   ❌ DELETE /api/payments/:id (oleh ketua): Gagal -', error.response?.data?.message || error.message);
    }
    ...
    // Test DELETE /api/payments/:id (oleh bendahara - seharusnya gagal)
    console.log('\n   2. Menguji DELETE /api/payments/:id (oleh bendahara - seharusnya gagal)');
    try {
      const response2 = await axios.delete(`${BASE_URL}/api/payments/${newPaymentId2}`, { 
        headers: { 
          'Authorization': `Bearer ${tokens.bendahara}`,
          'Content-Type': 'application/json'
        } 
      });
      console.log('   ❌ DELETE /api/payments/:id (oleh bendahara): Seharusnya gagal tapi berhasil - Status:', response2.status);
    } catch (error) {
      if (error.response && error.response.status === 403) {
        console.log('   ✅ DELETE /api/payments/:id (oleh bendahara): Ditolak dengan benar - Status:', error.response.status);
        console.log('      Pesan:', error.response.data.message);
      } else {
        console.log('   ❌ DELETE /api/payments/:id (oleh bendahara): Error tak terduga -', error.response?.data?.message || error.message);
      }
    }

    // Test DELETE /api/payments/:id (oleh sekretaris - seharusnya gagal)
    console.log('\n   3. Menguji DELETE /api/payments/:id (oleh sekretaris - seharusnya gagal)');
    try {
      const newPayment3 = {
        memberId: memberId,
      ...
      const newPaymentId3 = createResponse3.data.payment.id;
      console.log('   ➕ Pembayaran baru dibuat untuk pengujian delete sekretaris:', newPaymentId3);

      const response3 = await axios.delete(`${BASE_URL}/api/payments/${newPaymentId3}`, { 
        headers: { 
          'Authorization': `Bearer ${tokens.sekretaris}`,
          'Content-Type': 'application/json'
        } 
      });
      console.log('   ❌ DELETE /api/payments/:id (oleh sekretaris): Seharusnya gagal tapi berhasil - Status:', response3.status);
    } catch (error) {
      if (error.response && error.response.status === 403) {
        console.log('   ✅ DELETE /api/payments/:id (oleh sekretaris): Ditolak dengan benar - Status:', error.response.status);
        console.log('      Pesan:', error.response.data.message);
      } else {
        console.log('   ❌ DELETE /api/payments/:id (oleh sekretaris): Error tak terduga -', error.response?.data?.message || error.message);
      }
    }
  } else {
...
async function testDeleteExpensesEndpoint(tokens) {
  ...
  if (newExpenseId) {
    // Test DELETE /api/expenses/:id (oleh ketua - seharusnya berhasil)
    console.log('\n   1. Menguji DELETE /api/expenses/:id (oleh ketua)');
    try {
      const response = await axios.delete(`${BASE_URL}/api/expenses/${newExpenseId}`, { 
        headers: { 
          'Authorization': `Bearer ${tokens.admin}`,
          'Content-Type': 'application/json'
        } 
      });
      console.log('   ✅ DELETE /api/expenses/:id (oleh ketua): Berhasil - Status:', response.status);
      console.log('      Pesan:', response.data.message);
    } catch (error) {
      console.log('   ❌ DELETE /api/expenses/:id (oleh ketua): Gagal -', error.response?.data?.message || error.message);
    }
    ...
    // Test DELETE /api/expenses/:id (oleh bendahara - seharusnya gagal)
    console.log('\n   2. Menguji DELETE /api/expenses/:id (oleh bendahara - seharusnya gagal)');
    try {
      const response2 = await axios.delete(`${BASE_URL}/api/expenses/${newExpenseId2}`, { 
        headers: { 
          'Authorization': `Bearer ${tokens.bendahara}`,
          'Content-Type': 'application/json'
        } 
      });
      console.log('   ❌ DELETE /api/expenses/:id (oleh bendahara): Seharusnya gagal tapi berhasil - Status:', response2.status);
    } catch (error) {
      if (error.response && error.response.status === 403) {
        console.log('   ✅ DELETE /api/expenses/:id (oleh bendahara): Ditolak dengan benar - Status:', error.response.status);
        console.log('      Pesan:', error.response.data.message);
      } else {
        console.log('   ❌ DELETE /api/expenses/:id (oleh bendahara): Error tak terduga -', error.response?.data?.message || error.message);
      }
    }

    // Test DELETE /api/expenses/:id (oleh sekretaris - seharusnya gagal)
    console.log('\n   3. Menguji DELETE /api/expenses/:id (oleh sekretaris - seharusnya gagal)');
    try {
      const newExpense3 = {
        date: '2025-08-22',
        category: 'kain_kafan',
      ...
      const response3 = await axios.delete(`${BASE_URL}/api/expenses/${newExpenseId3}`, { 
        headers: { 
          'Authorization': `Bearer ${tokens.sekretaris}`,
          'Content-Type': 'application/json'
        } 
      });
      console.log('   ❌ DELETE /api/expenses/:id (oleh sekretaris): Seharusnya gagal tapi berhasil - Status:', response3.status);
    } catch (error) {
      if (error.response && error.response.status === 403) {
        console.log('   ✅ DELETE /api/expenses/:id (oleh sekretaris): Ditolak dengan benar - Status:', error.response.status);
        console.log('      Pesan:', error.response.data.message);
      } else {
        console.log('   ❌ DELETE /api/expenses/:id (oleh sekretaris): Error tak terduga -', error.response?.data?.message || error.message);
      }
    }
  } else {
...
module.exports = { testDeleteEndpoints };