// tests/test-delete-functional.js
...
async function testDeleteFunctional() {
  console.log('🧪 Memulai pengujian fungsional endpoint DELETE...');
  ...
  try {
    ...
    console.log('\n🎉 Pengujian endpoint DELETE fungsional selesai!');
  } catch (error) {
...
module.exports = { testDeleteFunctional };